...
| 许可证 | `llm/` 为 LGPL-3.0，其余为 Apache-2.0 |
...
仓库是复合许可证：[根许可证说明](https://github.com/looplj/axonhub/blob/ed6119a168483a205a85a2f38c7153f5cf1b61a6/LICENSE#L1) 指定 `llm/` 为 LGPL-3.0，其余为 Apache-2.0。推荐路线不修改 `llm/`，但正式部署前仍需完成许可证审查；本报告不构成法律意见。
