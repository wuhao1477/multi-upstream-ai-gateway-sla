...
已完成。矩阵按 FR-001～FR-105 分组，区分原生覆盖、L0 外置、L1/L2 和 L3 核心改造；已加入 NewAPI 与 Sub2API。全部候选的价格可信版本、共享余额、会话、测活和 SLA 账目仍需外部控制组件。见 [PRD 能力覆盖矩阵](./research/capability-matrix.md)。
