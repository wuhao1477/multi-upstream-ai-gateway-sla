...
| [14 验收矩阵](./14-acceptance-matrix.md) | **AC → 里程碑 → 可执行判定方法**；PM 与开发的验收契约（**一期 28 条 + 二期 8 条 = 36**，与本文里程碑表及 [PRD](../PRD.md) 一致） | 草案（M1 前定稿） |
