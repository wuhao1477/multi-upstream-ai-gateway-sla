...
| [14 验收矩阵](./14-acceptance-matrix.md) | **AC → 里程碑 → 可执行判定方法**；PM 与开发的验收契约（订阅 5 条移入二期） | 草案（M1 前定稿） |
| [15 一期范围与开工前确认清单](./15-scope-and-preflight.md) | 一期/二期范围（**订阅制移入二期**）+ 开工前必须确认的隐患清单 | **范围已定；隐患待确认** |
