...
| **M4 经营与验收** | 冷却/样本门槛、容量保留、告警 P1～P3（落库）、一期验收矩阵收口、100～1000 QPS 压测 | 参数 5/11/12/16、FR-114 | ① [14 验收矩阵](./14-acceptance-matrix.md) 的**一期 25 条 AC 全绿**且证据留档（二期 7 条：订阅 AC-20~24、测活 AC-09/10 不在本期）；② LOAD：100～1000 QPS 下决策开销 **P99 ≤50ms**（FR-110/AC-18） |
