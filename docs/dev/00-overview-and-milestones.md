...
| **M2 流式 SLA 核心** | 内容感知 TTFT、动态期限、首字前接管、mid-stream 取消传播、取消口径归并 | 硬约束 4/5/7，AC-30～32 | ① MOCK 场景全绿（role-only/心跳/空 SSE/慢首字/中断/abort）；② **AC-06/07/12/15/25 全通过**（[14](./14-acceptance-matrix.md) 一期集；AC-09/10 随主动测活移二期）；③ 内容感知 TTFT 在三类元事件场景下**均不出现 ≈0ms** |
