...
| 变量 | 必填 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `SLA_IMAGE` | 否 | `ghcr.io/wuhao1477/multi-upstream-ai-gateway-sla:v1.0.2` | 要运行的发布镜像，可用于升级/回滚 |
...
```bash
SLA_IMAGE=ghcr.io/wuhao1477/multi-upstream-ai-gateway-sla:v1.0.2
docker compose pull
docker compose up -d
curl http://127.0.0.1:18081/healthz
```
...
- Release：[v1.0.2](https://github.com/wuhao1477/multi-upstream-ai-gateway-sla/releases/tag/v1.0.2)
- 镜像：`ghcr.io/wuhao1477/multi-upstream-ai-gateway-sla:v1.0.2`
