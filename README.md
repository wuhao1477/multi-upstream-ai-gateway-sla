...
当前发布版本：`v1.0.3` · 当前交付阶段：**P1 上游采集与管理**

[部署指南](docs/DEPLOYMENT.md) · [Release v1.0.3](https://github.com/wuhao1477/multi-upstream-ai-gateway-sla/releases/tag/v1.0.3) · [Apache-2.0](LICENSE)
...
| 变量 | 默认值 | 说明 |
| --- | --- | --- |
| `SLA_IMAGE` | `ghcr.io/wuhao1477/multi-upstream-ai-gateway-sla:v1.0.3` | 发布镜像版本 |
...
```text
ghcr.io/wuhao1477/multi-upstream-ai-gateway-sla:v1.0.3
```

当前 Release 包含两个平台的二进制包和 `SHA256SUMS`，详见 [Release v1.0.3](https://github.com/wuhao1477/multi-upstream-ai-gateway-sla/releases/tag/v1.0.3) 与 [发布工作流](.github/workflows/release.yml)。
